                                                 ...
                                                 <tbody>
                                                        ...
                                                        <tr>
                                                               ...
                                                               <td>
                                                                      ...
                                                                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#_BlockUser{{$user->id}}">
                                                                             <i class="mdi mdi-block-helper"></i>
                                                                      </button>
                                                                      @else
                                                                      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#_BlockUser{{$user->id}}">
                                                                             <i class="mdi mdi-checkbox-blank-circle-outline"></i>
                                                                      </button>
                                                                      @endif

                                                                      <button type="button" class="btn btn-info" data-toggle="modal" data-target="#_EditUser{{$user->id}}">
                                                                             <i class="mdi mdi-pencil"></i>
                                                                      </button>
                                                                      <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#_DeleteUser{{$user->id}}">
                                                                             <i class="mdi mdi-delete"></i>
                                                                      </button>

                                                                      <a href = "{{ url('users/get-profile') }}/{{$user->id}}" class="btn btn-success" ><i class="mdi mdi-eye"></i></a>
                                                               </td>
