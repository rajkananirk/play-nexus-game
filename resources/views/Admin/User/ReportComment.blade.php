                     ...
                     <div class="row">
                            <div class="col-xs-12">
                                   <div class="page-title-box">
                                          <h4 class="page-title">Report Comment List</h4>
       ...
       <div id="_ActionUser{{$user->report_id}}" class="modal fade" role="dialog" style="background-color: #ffffff87;">
              <div class="modal-dialog">
                     ...
                     <div class="modal-content">
                            ...
                            <form class="form-horizontal" action="{{ url('report-action-comment') }}" method="post" enctype="multipart/form-data">
                                   @csrf
