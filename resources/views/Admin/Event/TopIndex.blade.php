                     ...
                     <div class="row">
                            <div class="col-xs-12">
                                   <div class="page-title-box">
                                          <h4 class="page-title">Top Event</h4>
                                          <div class="pull-right">
                                                 <a  class="btn btn-success pull-right" data-target="#_Addtopevent" data-toggle="modal"><i class=" mdi mdi-playlist-plus"></i>&nbsp;Add Top Event</a>
                                          </div>
                                          <div class="clearfix">
                                          ...
                                          <table id="clients" class="table table-striped table-bordered">
                                                 ...
                                                 <tbody>
                                                        ...
                                                        <tr>
                                                               ...
                                                               <td>{{$user->location}}</td>
                                                               <td>{{$user->event_prefecture}}</td>
                                                               <td>{{$user->event_member}}</td>
                                                               <td>
                                                                      <a type="button" class="btn btn-info"  target="_blank" href="{{$user->event_register_link}}">Link</a>
       ...
       <div class="modal-dialog modal-lg">
              ...
              <div class="modal-content">
                     <div class="modal-header">
                            ...
                            <h4 class="modal-title text-black">Edit Top Event</h4>
                     </div>
                                   ...
                                   <div class="text-center">
                                          ...
                                          <div class="member-card">
                                                 ...
                                                 <div class="form-group">
                                                        ...
                                                        <div class="col-md-10">
                                                               <input type="text" name="event_prefecture" class="form-control" value="{{$user->event_prefecture}}">
                                                        </div>
                                                 </div>
                                                 <div class="form-group">
                                                        <label class="col-md-2 control-label">Member</label>
                                                        <div class="col-md-10">
                                                               <input type="text" name="event_member" class="form-control" value="{{$user->event_member}}">
                                                        </div>
                                                 </div>
                                                 <div class="form-group">
                                                        <label class="col-md-2 control-label">Register Link</label>
                                                        <div class="col-md-10">
                                                               <input type="text" name="event_register_link" class="form-control" value="{{$user->event_register_link}}">
                                                        </div>
                                                 </div>
                                                 <div class="form-group">
                                                        <label class="col-md-2 control-label">Event Date</label>
                                                        <div class="col-md-10">
                                                               <input type="date" name="event_date" class="form-control" value="{{$user->event_date}}">
                                                        </div>
                                                 </div>
...
<div id="_Addtopevent" class="modal fade" role="dialog" style="background-color: #ffffff87;">
       <div class="modal-dialog modal-lg">
              ...
              <div class="modal-content">
                     <div class="modal-header">
                            <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title text-black">Add Top Event</h4>
                     </div>
                     <form class="form-horizontal" action="{{ url('add-feed') }}" method="post" enctype="multipart/form-data">
                            @csrf
                                   ...
                                   <div class="text-center">
                                          ...
                                          <div class="member-card">
                                                 ...
                                                 <div class="form-group">
                                                        <label class="col-md-2 control-label">Prefecture</label>
                                                        <div class="col-md-10">
                                                               <input type="text" name="event_prefecture" class="form-control">
                                                        </div>
                                                 </div>
                                                 <div class="form-group">
                                                        <label class="col-md-2 control-label">Member</label>
                                                        <div class="col-md-10">
                                                               <input type="text" name="event_member" class="form-control">
                                                        </div>
                                                 </div>
                                                 <div class="form-group">
                                                        <label class="col-md-2 control-label">Register Link</label>
                                                        <div class="col-md-10">
                                                               <input type="text" name="event_register_link" class="form-control">
                                                        </div>
                                                 </div>
                                                 <div class="form-group">
                                                        <label class="col-md-2 control-label">Event Date</label>
...
<div id="_DeleteUser{{$user->feed_id}}" class="modal fade" role="dialog" style="background-color: #ffffff87;">
       <div class="modal-dialog">
              ...
              <div class="modal-content">
                     <div class="modal-header">
                            <button type="button" class="close text-white" data-dismiss="modal">&times;</button>
                            <h4 class="modal-title text-black">Delete Top Event</h4>
                     </div>
